...
/obj/machinery/telecomms/hub/preset/odyssey
	id = "Hub"
	network = "tcommsat"
...
/obj/machinery/telecomms/bus/preset/odyssey
	id = "Main Bus"
	network = "tcommsat"
...
/obj/machinery/telecomms/bus/odyssey/main/Initialize()
	. = ..()
...
/obj/machinery/telecomms/processor/preset/odyssey
	id = "Main Processor"
	network = "tcommsat"
	autolinkers = list("mainprocessor") // processors are sort of isolated; they don't need backward links

/obj/machinery/telecomms/server/preset/odyssey
	id = "Server"
	freq_listening = list(SCI_FREQ, MED_FREQ, SUP_FREQ, SRV_FREQ, SEC_FREQ, COMM_FREQ, ENG_FREQ, AI_FREQ, PUB_FREQ, ENT_FREQ)
	channel_tags = list(
