...
/obj/machinery/door_timer/odyssey/LateInitialize()
...
/obj/machinery/door_timer/odyssey/timer_start()
...
/obj/machinery/door_timer/odyssey/timer_end(var/broadcast_to_huds = FALSE)
	if(stat & (NOPOWER|BROKEN))	return 0
