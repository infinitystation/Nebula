/obj/machinery/chemical_dispenser/bar_coffee/old
	name = "old coffee maker"
	desc = "Singlehandedly kicking ass for as long as the ship's been around."
	icon = 'maps/odyssey/icons/coffee.dmi'
