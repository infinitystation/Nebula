#define EVAC_ODYSSEY_IDLE       0
#define EVAC_ODYSSEY_PREPPING   1
#define EVAC_ODYSSEY_LAUNCHING  2
#define EVAC_ODYSSEY_IN_TRANSIT 3
#define EVAC_ODYSSEY_COOLDOWN   4
#define EVAC_ODYSSEY_COMPLETE   5

/datum/evacuation_controller/starship/odyssey //We do some things differently. Literally. This just overwrites two lines.

/datum/map/odyssey
	evac_controller_type = /datum/evacuation_controller/starship/odyssey

/datum/evacuation_controller/starship/odyssey/cancel_evacuation() //Overwrites yay
	if(!can_cancel())
		return 0

	evac_cooldown_time = world.time + (world.time - evac_called_at)
	state = EVAC_ODYSSEY_COOLDOWN
...
/datum/evacuation_controller/starship/odyssey/call_evacuation(var/mob/user, var/_emergency_evac, var/forced, var/skip_announce, var/autotransfer)

	if(state != EVAC_ODYSSEY_IDLE)
		return 0
...
#undef EVAC_ODYSSEY_IDLE
#undef EVAC_ODYSSEY_PREPPING
#undef EVAC_ODYSSEY_IN_TRANSIT
#undef EVAC_ODYSSEY_COOLDOWN
#undef EVAC_ODYSSEY_COMPLETE
