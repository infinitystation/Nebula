/datum/job/odyssey/command/captain
	...
	total_positions = 1
	spawn_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/odyssey/captain
...
/datum/job/odyssey/command/captain/get_description_blurb()
...
/datum/job/odyssey/command/first_officer
	...
	total_positions = 1
	spawn_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/odyssey/first_officer
...
/datum/job/odyssey/command/first_officer/get_description_blurb()
...
/datum/job/odyssey/command/bridge_officer
	...
	total_positions = 2
	spawn_positions = 2
	outfit_type = /decl/hierarchy/outfit/job/odyssey/bridge_officer
...
/datum/job/odyssey/command/bridge_officer/get_description_blurb()
