/datum/job/odyssey/security/SSC
	...
	total_positions = 1
	spawn_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/odyssey/SSC
...
/datum/job/odyssey/security/SSC/get_description_blurb()
...
/datum/job/odyssey/security/brig_chief
	...
	total_positions = 1
	spawn_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/odyssey/security/brig_chief
...
/datum/job/odyssey/security/brig_chief/get_description_blurb()
...
/datum/job/odyssey/security/armsmen
	...
	total_positions = 2
	spawn_positions = 2
	outfit_type = /decl/hierarchy/outfit/job/odyssey/security/armsman
...
/datum/job/odyssey/security/armsmen/get_description_blurb()
...
/datum/job/odyssey/security/gunship_pilot
	title = "Gunship Pilot"
	access = list(access_security, access_brig, access_sec_doors, access_forensics_lockers, access_external_airlocks, access_maint_tunnels, access_eva)
	total_positions = 0
	spawn_positions = 0
	outfit_type = 	/decl/hierarchy/outfit/job/odyssey/security/gunship_pilot

/datum/job/odyssey/security/gunship_pilot/get_description_blurb()
