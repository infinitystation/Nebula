...
/obj/item/documents/engineering
	...
	desc = "\"Top Secret\" engineering blueprints, filled with diagrams, design specifications, and material rosters used in the construction of a Wolf-Class frigate."
	description_antag = "The blueprints for the Wolf-Class are extremely tightly kept and would sell for a considerable amount of money to the right person."
	icon_state = "docs_blue"
