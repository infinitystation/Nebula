...
/datum/map/odyssey // setting the map to use this list
...
/decl/security_level/default/odyssey/code_delta
	...
	var/static/datum/announcement/priority/security/security_announcement_delta = new(do_log = 0, do_newscast = 1, new_sound = sound('maps/odyssey/sounds/delta.ogg'))

/decl/security_level/default/odyssey/code_delta/switching_up_to()
