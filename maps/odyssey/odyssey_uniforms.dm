...
/obj/item/clothing/accessory/chevrons
	...
	icon = 'maps/odyssey/icons/rank_chevrons.dmi'
...
/obj/item/clothing/accessory/dept_stripes
	...
	hide_on_uniform_rolldown = TRUE
	icon = 'maps/odyssey/icons/dept_stripes.dmi'
...
/obj/item/clothing/accessory/ranks/enlisted
	icon = 'maps/odyssey/icons/rank_ea_enlisted.dmi'

/obj/item/clothing/accessory/ranks/enlisted/senior
	icon = 'maps/odyssey/icons/rank_ea_enlisted_senior.dmi'
...
/obj/item/clothing/accessory/ranks/officer
	icon = 'maps/odyssey/icons/rank_ea_officer.dmi'
...
/obj/item/clothing/accessory/ranks/command
	icon = 'maps/odyssey/icons/rank_ea_command.dmi'
