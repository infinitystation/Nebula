...
/datum/shuttle/autodock/overmap/gnat
	name = "Gnat"
	shuttle_area = list(/area/odyssey/shuttle/gnat/cockpit,/area/odyssey/shuttle/gnat/passenger, /area/odyssey/shuttle/gnat/cargo, /area/odyssey/shuttle/gnat/maint)
