...
/decl/hierarchy/outfit/job/wyrm/crewmember
	name = WYRM_OUTFIT_JOB_NAME("Crewmember")

/decl/hierarchy/outfit/job/wyrm/crewmember/pre_equip(mob/living/carbon/human/H)
	..()
