...
/datum/map/torch/send_welcome()
	...
	var/welcome_text = "<center><img src = iseologo.png /><br /><font size = 3><b>[full_name]</b> Sensor Readings:</font><br>"
	...
	post_comm_message("[full_name] Sensor Readings", welcome_text)
