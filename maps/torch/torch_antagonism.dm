...
/decl/special_role/changeling
	blacklisted_jobs = list(/datum/job/computer, /datum/job/robot, /datum/job/submap, /datum/job/captain, /datum/job/hop, /datum/job/submap)
	protected_jobs = list(/datum/job/medical_trainee, /datum/job/engineer_trainee)

/decl/special_role/godcultist
	blacklisted_jobs = list(/datum/job/computer, /datum/job/robot, /datum/job/chaplain, /datum/job/submap, /datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/submap)
	protected_jobs = list(/datum/job/medical_trainee, /datum/job/engineer_trainee)

/decl/special_role/cultist
	blacklisted_jobs = list(/datum/job/computer, /datum/job/robot, /datum/job/chaplain, /datum/job/psychiatrist, /datum/job/submap, /datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/submap)
	protected_jobs = list(/datum/job/medical_trainee, /datum/job/engineer_trainee)

/decl/special_role/loyalists
	blacklisted_jobs = list(/datum/job/computer, /datum/job/robot, /datum/job/submap, /datum/job/submap)
...
/decl/special_role/traitor
	blacklisted_jobs = list(/datum/job/submap, /datum/job/captain, /datum/job/hop, /datum/job/computer, /datum/job/submap, /datum/job/hos)
	protected_jobs = list(/datum/job/medical_trainee, /datum/job/engineer_trainee)
...
/decl/special_role/ert/equip(var/mob/living/carbon/human/player)
