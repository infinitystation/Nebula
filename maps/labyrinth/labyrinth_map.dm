...
/datum/map/labyrinth/build_exoplanets()
	...
	for(var/i = 0, i < num_exoplanets, i++)
		var/exoplanet_type = pick(subtypesof(/obj/effect/overmap/visitable/sector/exoplanet) - /obj/effect/overmap/visitable/sector/exoplanet/snow/labyrinth)
	...
	var/obj/effect/overmap/visitable/sector/exoplanet/labyrinth = new /obj/effect/overmap/visitable/sector/exoplanet/snow/labyrinth(null, 2)
