...
/decl/hierarchy/outfit/job/constellation
	hierarchy_type = /decl/hierarchy/outfit/job/constellation
	pda_type = /obj/item/modular_computer/pda
	pda_slot = slot_l_store_str
	l_ear = null
	r_ear = null

/decl/hierarchy/outfit/job/constellation/hand
	name = TRADESHIP_OUTFIT_JOB_NAME("Deck Hand")

/decl/hierarchy/outfit/job/constellation/hand/pre_equip(mob/living/carbon/human/H)
	..()
...
/decl/hierarchy/outfit/job/constellation/hand/cook
