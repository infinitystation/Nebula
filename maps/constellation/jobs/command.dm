...
/datum/job/constellation_captain/equip(var/mob/living/carbon/human/H)
	. = ..()
	if(H)
		H.verbs |= /mob/proc/tradehouse_rename_ship
		H.verbs |= /mob/proc/tradehouse_rename_company

/datum/job/constellation_captain/get_access()
...
/mob/proc/tradehouse_rename_ship()
	...
	var/obj/effect/overmap/visitable/ship/constellation/B = locate() in world
	if(B)
...
/datum/job/constellation_first_mate
	...
	outfit_type = /decl/hierarchy/outfit/job/constellation/mate
