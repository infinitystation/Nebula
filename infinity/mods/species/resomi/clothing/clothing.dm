...
/obj/item/clothing/shoes/magboots/Initialize()
	...
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/magboots.dmi'
	. = ..()

/obj/item/clothing/shoes/galoshes/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/galoshes.dmi'
	. = ..()
...
/obj/item/clothing/gloves/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/gloves.dmi'
	. = ..()
...
/obj/item/card/id/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/id.dmi'
	. = ..()
...
/obj/item/clothing/mask/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/onmob_mask.dmi'
	. = ..()
...
/obj/item/storage/backpack/satchel/Initialize()
	. = ..()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/satchel.dmi'

/obj/item/storage/backpack/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/backpack.dmi'
	. = ..()

/obj/item/tank/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/onmob_back.dmi'
	. = ..()
...
/obj/item/clothing/head/radiation/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/rad_helm.dmi'
	. = ..()

/obj/item/clothing/suit/radiation/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/rad_suit.dmi'
	. = ..()
//material cloak
/obj/item/clothing/accessory/cloak/hide/Initialize()
	LAZYINITLIST(sprite_sheets)
	sprite_sheets[BODYTYPE_RESOMI] = 'infinity/mods/species/resomi/icons/clothing/exp/cloak_hide.dmi'
	. = ..()
