...
/obj/item/clothing/suit/storage/hooded/polychromic
	...
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/suit/polychromic.dmi'
...
/obj/item/clothing/head/winterhood/polychromic_hood
	name = "hood"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/head/polychromic_hood.dmi'
	bodytype_restricted = list(BODYTYPE_RESOMI)
...
/obj/item/clothing/under/resomi
	...
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/small_jumpsuit.dmi'
	bodytype_restricted = list(BODYTYPE_RESOMI)

/obj/item/clothing/under/resomi/simple
	name = "small smock"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/small_smock.dmi'

/obj/item/clothing/under/resomi/rainbow
	name = "rainbow smock"
	desc = "Why would someone wear this?"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/rainbow_smock.dmi'

/obj/item/clothing/under/resomi/engine
	name = "small engineering smock"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/engineering_smock.dmi'

/obj/item/clothing/under/resomi/security
	name = "small security smock"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/security_smock.dmi'

/obj/item/clothing/under/resomi/medical
	name = "small medical smock"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/medical_smock.dmi'

/obj/item/clothing/under/resomi/science
	name = "small science smock"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/science_smock.dmi'

/obj/item/clothing/under/resomi/command
	name = "small command uniform"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/under/command_uniform.dmi'

//Shoes
/obj/item/clothing/shoes/resomi/footwraps
	name = "cloth footwraps"
	desc = "A roll of treated canvas used for wrapping paws"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/feet/footwraps.dmi'
	force = 0
...
/obj/item/clothing/shoes/resomi/footwraps/socks_resomi
	...
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/feet/koishi.dmi'

/obj/item/clothing/shoes/resomi
	name = "small shoes"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/feet/shoes.dmi'
	color = COLOR_GRAY
	bodytype_restricted = list(BODYTYPE_RESOMI)
...
/obj/item/clothing/under/resomi/space
	...
	icon       = 'infinity/mods/species/resomi/icons/clothing/exp/under/pressure_suit.dmi'
...
/obj/item/clothing/head/resomi_space
	...
	icon       = 'infinity/mods/species/resomi/icons/clothing/exp/head/space_dome.dmi'
	bodytype_restricted = list(BODYTYPE_RESOMI)
...
/obj/item/clothing/head/helmet/space/void/engineering/resomi
	...
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/head/heavy.dmi'

	bodytype_restricted = list(BODYTYPE_RESOMI)

/obj/item/clothing/suit/space/void/engineering/resomi
	name = "heavy resomi voidsuit"
	icon = 'infinity/mods/species/resomi/icons/clothing/exp/suit/heavy_suit.dmi'
