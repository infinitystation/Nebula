...
/datum/sprite_accessory/hair/taj
	...
	icon = 'infinity/mods/species/tajaran/icons/hair.dmi'
...
/datum/sprite_accessory/facial_hair/taj
	...
	species_allowed = list(SPECIES_TAJARA)
	icon = 'infinity/mods/species/tajaran/icons/facial.dmi'
...
/datum/sprite_accessory/marking/taj
	...
	icon = 'infinity/mods/species/tajaran/icons/markings.dmi'
...
/datum/sprite_accessory/skin/tajaran
	...
	icon_state = "default"
	icon = 'infinity/mods/species/tajaran/icons/body.dmi'
	species_allowed = list(SPECIES_TAJARA)
