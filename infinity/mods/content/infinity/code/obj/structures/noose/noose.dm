...
/obj/structure/noose
	...
	icon_state = "noose"
	icon = 'infinity/mods/content/infinity/icons/obj/structures/noose.dmi'
	anchored = TRUE
	can_buckle = TRUE
	buckle_lying = FALSE
	layer = 5
	...
	if(M == user)
		...
		if(do_after(user, 5 SECONDS))
			if(buckle_mob(M))
				...
				playsound(user, 'infinity/mods/content/infinity/sound/obj/structures/noosed.ogg', 50, 1, -1)
				return TRUE
...
/obj/structure/noose/Process()
	...
	switch(ticks)
		...
		if(3)
			...
			if(buckled_mob)
				playsound(buckled_mob, 'infinity/mods/content/infinity/sound/obj/structures/noose_idle.ogg', 50, 1, -3)
