...
/obj/item/music_player/proc/set_mode(value)
	...
	playsound(src, mode == (PLAYER_STATE_OFF || PLAYER_STATE_PAUSE) ? 'infinity/mods/content/infinity/sound/obj/machinery/switch/small1.ogg' : 'infinity/mods/content/infinity/sound/obj/machinery/switch/small2.ogg', 35)
...
/obj/item/music_player/proc/eject(mob/user)
	...
	playsound(src, 'infinity/mods/content/infinity/sound/obj/machinery/Custom_screwdriveropen.ogg', 20, 1)
	if(user)
		visible_message(
...
/obj/item/music_player/radio
	...
	icon = 'infinity/mods/content/infinity/icons/obj/items/music_player_radio.dmi'

// Boombox
/obj/item/music_player/boombox
	name = "black boombox"
	desc = "A musical audio player station, also known as boombox or ghettobox. Very robust."
	icon = 'infinity/mods/content/infinity/icons/obj/items/music_player_boombox.dmi'
...
/obj/item/music_player/debug
	...
	icon = 'infinity/mods/content/infinity/icons/obj/items/music_player_console.dmi'
