...
/obj/item/clothing/suit/storage/hooded/polychromic
	...
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/suit/polychromic.dmi'
...
/obj/item/clothing/head/winterhood/polychromic_hood
	name = "hood"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/head/polychromic_hood.dmi'
	bodytype_restricted = list(BODYTYPE_RESOMI)
...
/obj/item/clothing/under/resomi
	...
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/small_jumpsuit.dmi'
	bodytype_restricted = list(BODYTYPE_RESOMI)

/obj/item/clothing/under/resomi/simple
	name = "small smock"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/small_smock.dmi'

/obj/item/clothing/under/resomi/rainbow
	name = "rainbow smock"
	desc = "Why would someone wear this?"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/rainbow_smock.dmi'

/obj/item/clothing/under/resomi/engine
	name = "small engineering smock"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/engineering_smock.dmi'

/obj/item/clothing/under/resomi/security
	name = "small security smock"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/security_smock.dmi'

/obj/item/clothing/under/resomi/medical
	name = "small medical smock"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/medical_smock.dmi'

/obj/item/clothing/under/resomi/science
	name = "small science smock"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/science_smock.dmi'

/obj/item/clothing/under/resomi/command
	name = "small command uniform"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/command_uniform.dmi'

/obj/item/clothing/under/resomi/stylish_command
	name = "small stylish uniform"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/stylish_form.dmi'

/obj/item/clothing/under/resomi/gray_utility
	name = "small grey uniform"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/gray_utility.dmi'

/obj/item/clothing/under/resomi/black_utility
	name = "small black uniform"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/under/black_utility.dmi'

//Shoes
/obj/item/clothing/shoes/resomi/footwraps
	name = "cloth footwraps"
	desc = "A roll of treated canvas used for wrapping paws"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/feet/footwraps.dmi'
	force = 0
...
/obj/item/clothing/shoes/resomi
	name = "small shoes"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/feet/shoes.dmi'
	color = COLOR_GRAY
	bodytype_restricted = list(BODYTYPE_RESOMI)
...
/obj/item/clothing/under/resomi/space
	...
	icon       = 'mods_infinity/species/resomi/icons/clothing/exp/under/pressure_suit.dmi'
...
/obj/item/clothing/head/resomi_space
	...
	icon       = 'mods_infinity/species/resomi/icons/clothing/exp/head/space_dome.dmi'
	bodytype_restricted = list(BODYTYPE_RESOMI)
...
/obj/item/clothing/head/helmet/space/void/engineering/resomi
	...
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/head/heavy.dmi'

	bodytype_restricted = list(BODYTYPE_RESOMI)

/obj/item/clothing/suit/space/void/engineering/resomi
	name = "heavy resomi voidsuit"
	icon = 'mods_infinity/species/resomi/icons/clothing/exp/suit/heavy_suit.dmi'
