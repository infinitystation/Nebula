...
/obj/item/music_player/proc/set_mode(value)
	...
	playsound(src, mode == (PLAYER_STATE_OFF || PLAYER_STATE_PAUSE) ? 'mods_infinity/content/starlight/datum/atom/obj/item/music_player/switch_small1.ogg' : 'mods_infinity/content/starlight/datum/atom/obj/item/music_player/switch_small2.ogg', 35)
...
/obj/item/music_player/proc/eject(mob/user)
	...
	playsound(src, 'mods_infinity/content/starlight/datum/atom/obj/item/music_player/custom_open.ogg', 20, 1)
	if(user)
		visible_message(
...
/obj/item/music_player/radio
	...
	icon = 'mods_infinity/content/starlight/datum/atom/obj/item/music_player/music_player_radio.dmi'

// Boombox
/obj/item/music_player/boombox
	name = "black boombox"
	desc = "A musical audio player station, also known as boombox or ghettobox. Very robust."
	icon = 'mods_infinity/content/starlight/datum/atom/obj/item/music_player/music_player_boombox.dmi'
...
/obj/item/music_player/debug
	...
	icon = 'mods_infinity/content/starlight/datum/atom/obj/item/music_player/music_player_console.dmi'
