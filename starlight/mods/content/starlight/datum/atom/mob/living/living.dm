...
/mob/living/turf_collision(turf/T, speed)
	...
	playsound(T, pick(list(
		'starlight/mods/content/starlight/datum/atom/mob/living/gore/smash1.ogg',
		'starlight/mods/content/starlight/datum/atom/mob/living/gore/smash2.ogg',
		'starlight/mods/content/starlight/datum/atom/mob/living/gore/smash3.ogg',
		'starlight/mods/content/starlight/datum/atom/mob/living/gore/trauma1.ogg')), 50, 1, 1)
