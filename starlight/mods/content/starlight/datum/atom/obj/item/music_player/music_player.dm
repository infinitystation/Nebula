...
/obj/item/music_player/proc/set_mode(value)
	...
	playsound(src, mode == (PLAYER_STATE_OFF || PLAYER_STATE_PAUSE) ? 'starlight/mods/content/starlight/datum/atom/obj/item/music_player/switch_small1.ogg' : 'starlight/mods/content/starlight/datum/atom/obj/item/music_player/switch_small2.ogg', 35)
...
/obj/item/music_player/radio
	...
	icon = 'starlight/mods/content/starlight/datum/atom/obj/item/music_player/music_player_radio.dmi'

// Boombox
/obj/item/music_player/boombox
	name = "black boombox"
	desc = "A musical audio player station, also known as boombox or ghettobox. Very robust."
	icon = 'starlight/mods/content/starlight/datum/atom/obj/item/music_player/music_player_boombox.dmi'
...
/obj/item/music_player/debug
	...
	icon = 'starlight/mods/content/starlight/datum/atom/obj/item/music_player/music_player_console.dmi'
